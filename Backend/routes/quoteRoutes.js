...
import {addQuote, deleteQuote, getAllQuotes, getQuote, getQuotesByUser, updateQuote} from '../controllers/quoteController.js'
...
router.get('/getQuoteByUser', isLoggedIn, authorizedRoles('USER','ADMIN'),getQuotesByUser )
